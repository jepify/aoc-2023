...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `27.1µs` | `582.8µs` |
| [Day 2](./src/bin/02.rs) | `20.6µs` | `25.6µs` |
| [Day 3](./src/bin/03.rs) | `3.1ms` | `492.0µs` |
| [Day 4](./src/bin/04.rs) | `499.7µs` | `252.6µs` |
| [Day 15](./src/bin/15.rs) | `45.7µs` | `-` |
