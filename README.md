...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `27.1µs` | `576.9µs` |
| [Day 2](./src/bin/02.rs) | `18.8µs` | `25.0µs` |
| [Day 3](./src/bin/03.rs) | `3.0ms` | `494.2µs` |
| [Day 4](./src/bin/04.rs) | `476.4µs` | `255.3µs` |
| [Day 6](./src/bin/06.rs) | `328.0ns` | `591.0ns` |
| [Day 15](./src/bin/15.rs) | `47.8µs` | `-` |
